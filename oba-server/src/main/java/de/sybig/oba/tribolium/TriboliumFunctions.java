package de.sybig.oba.tribolium;
...
public class TriboliumFunctions extends OntologyFunctions implements
        OntologyFunction {

    private static final String TRIBOLIUM_NS = "http://purl.org/obo/owlapi/tribolium.anatomy";
    private static final String DEV_STAGESID = "TrOn_0000024";
    ...
    private HashSet<ObaClass> genericClasses;
    ...
    public Set<ObaClass> getDevStages() {
        if (devStages == null) {
            ...
            ObaClass devStageCls = ontology.getOntologyClass(DEV_STAGESID,
                    TRIBOLIUM_NS);
    ...
    public List<ObaClass> findGeneric(@PathParam("pattern") String searchPattern) {
        ...
        // In the owl representation of the OBO ontologie spaces are replace by '_'
